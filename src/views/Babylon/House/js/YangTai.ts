...
export function CreateYangTai({scene}:{scene:BABYLON.Scene}){
    YangTai = BABYLON.MeshBuilder.CreateBox('masterRoom',{
        width:6,
        height:4,
        depth: 1.6
    },scene)
    ...
    let ytw =  BABYLON.MeshBuilder.CreateBox('masterRoom',{
        width:6,
        height:4,
        depth: .1
    },scene)
    ytw.parent = YangTai
    let ytwDoor = BABYLON.MeshBuilder.CreateBox('masterRoom',{
        width:5,
        height:3.5,
        depth: .1
    },scene)
    ytwDoor.parent = YangTai
    ytwDoor.position = new BABYLON.Vector3(0,-.5,0)
    ...
    let ytwDoorLeft = BABYLON.MeshBuilder.CreateBox('masterRoom',{
        width:0.1,
        height:1.5,
        depth: 1.6
    },scene)
    ...
    let ytwDoorFront1 = BABYLON.MeshBuilder.CreateBox('masterRoom',{
        width:.8,
        height:1.5,
        depth: 0.1
    },scene)
    let ytwDoorFront2 = BABYLON.MeshBuilder.CreateBox('masterRoom',{
        width:5.2,
        height:1.5,
        depth: 0.1
    },scene)
